...
-  разработка документации в соответствии со стандартами или руководящими документами;
- написание спецификаций API и эксплуатационной документации для разных аудиторий.
...
-   быстрая адаптация к незнакомым предметным областям;
